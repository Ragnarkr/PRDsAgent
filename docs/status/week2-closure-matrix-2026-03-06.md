...
- 本次基线口径：`1.1=Completed`、`1.2=Completed`、`1.3~1.8=In Progress`
...
| 1.3 | In Progress | 待验收（评测集与标注规范未冻结） | `docs/status/1.3-test-cases-completion-plan.md`；`docs/status/1.3-test-execution-results.md` | manifest/hash与样本规模未达验收门槛 |
| 1.4 | In Progress | 待验收（压测三轮结果未完成） | `docs/status/1.4-performance-baseline-plan.md`；`docs/status/perf-and-ops-baseline.md` | staging环境与请求画像未完全就绪 |
...
## 3. 当前收口结论
- Week2 已完成：`1.1`、`1.2`
- Week2 进行中：`1.3`、`1.4`、`1.5`、`1.6`、`1.7`、`1.8`
